    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="company" style={{ color: modalTheme.text }}>
              Company
            </Label>
            <Input
              id="company"
          ...
          <div className="space-y-2">
            <Label htmlFor="budget" style={{ color: modalTheme.text }}>
              Budget Range
            </Label>
            <Select
          ...
          <div className="space-y-2">
            <Label htmlFor="summary" style={{ color: modalTheme.text }}>
              Project Summary * (140 chars max)
            </Label>
            <Textarea
              id="summary"
              required
