...
Submitted: ${new Date().toLocaleString()}
    ...
    setTimeout(() => {
      setFormData({ name: "", email: "", chain: "", tokenType: "", supply: "", launchDate: "" });
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription style={{ color: modalTheme.muted }}>
            Provide your token requirements and get a detailed quote within 48 hours.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="chain" style={{ color: modalTheme.text }}>Chain Preference *</Label>
            <Select required value={formData.chain} onValueChange={(value) => setFormData({ ...formData, chain: value })}>
              <SelectTrigger 
                style={{
                  backgroundColor: `${modalTheme.accent}08`,
                  border: `1px solid ${modalTheme.border}`,
          ...
          <div className="space-y-2">
            <Label htmlFor="tokenType" style={{ color: modalTheme.text }}>Token Type *</Label>
            <Select required value={formData.tokenType} onValueChange={(value) => setFormData({ ...formData, tokenType: value })}>
              <SelectTrigger 
                style={{
                  backgroundColor: `${modalTheme.accent}08`,
                  border: `1px solid ${modalTheme.border}`,
          ...
          <div className="space-y-2">
            <Label htmlFor="supply" style={{ color: modalTheme.text }}>Expected Supply *</Label>
            <Input
              id="supply"
              required
          ...
          <div className="space-y-2">
            <Label htmlFor="launchDate" style={{ color: modalTheme.text }}>Desired Launch Date *</Label>
            <Input
              id="launchDate"
              type="date"
              required
          ...
          <div className="flex items-start gap-3 pt-2">
            ...
            />
            <label htmlFor="gdpr-token" className="text-sm leading-relaxed cursor-pointer" style={{ color: modalTheme.muted }}>
