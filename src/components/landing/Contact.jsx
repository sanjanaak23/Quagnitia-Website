        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg leading-relaxed" style={{ color: theme.muted }}>
                Ready to transform your blockchain vision into reality? Get in touch with our expert team.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                >
                  <Mail className="w-6 h-6" strokeWidth={1.5} style={{ color: theme.accent }} />
                </div>
                <div>
                  <h3 className="font-semibold mb-1" style={{ color: theme.text }}>Email Us</h3>
                  <a 
                    href="mailto:info@quagnitia.com"
              ...
              >
                ...
                >
                  <MessageSquare className="w-6 h-6" strokeWidth={1.5} style={{ color: theme.accent }} />
                </div>
                <div>
                  <h3 className="font-semibold mb-1" style={{ color: theme.text }}>Response Time</h3>
                  <p style={{ color: theme.muted }}>Within 24 hours on business days</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="company" style={{ color: theme.text }}>Company</Label>
                <Input
                  id="company"
              ...
              <div className="space-y-2">
                <Label htmlFor="service" style={{ color: theme.text }}>Service Interest</Label>
                <Input
                  id="service"
              ...
              >
                ...
                Send Message
                <Send className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" strokeWidth={1.5} />
              </Button>
            </form>
          </div>
        </div>
